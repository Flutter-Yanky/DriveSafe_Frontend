        ...
        <div>
            ...
            <div className='flex justify-center'>
                <div className='w-2/3 h-108 bg-[#F3F8FF] mx-2 my-8'>
                    <h1 className='flex justify-center text-blue-500 font-bold text-2xl my-3 upload font-mono '>Insurance Document</h1>
                    {/* file upload */}
                    <Upload
                        ...
                        id="upload"
                    />
                    {error && <p className='text-red-500 ml-5 font-semibold'>Error: {error}</p>}
                    {success && <p className='text-green-500 ml-5 font-semibold'>Success: {success}</p>}
                </div>
            </div>
