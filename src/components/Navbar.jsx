      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="hidden grow items-start lg:flex">
          <ul className="ml-12 inline-flex space-x-8">
            ...
            <Link to="/home" className="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900">
        ...
        </div>
        {
          loggedIn ?
            ...
            <div className="hidden space-x-2 lg:flex items-center ">
              <div className="relative">
                ...
                {isOpen && (
                  <div className="absolute z-10 top-12 right-[-14rem] w-[32rem] bg-white border border-gray-200 shadow-lg rounded-md">
                    <div className="p-4">
                      {/* Notification items */}
          ...
          text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                <FaRegUser className='mx-auto text-md' />
                <p className=' text-xs'>
        ...
        <div className="flex items-center lg:hidden">
          ...
          <div className="relative left-36">
            <button
              onClick={toggleNotifications}
              className="relative block w-8 h-8 lg:hidden" // Hide on larger screens
            >
              {/* Icon */}
              <Bell className='mr-2 cursor-pointer' />
            </button>
            ...
            {/* Notification list */}
            {isOpen && (
              <div className="absolute z-10 top-12 right-[-2rem] w-[26rem] bg-white border border-gray-200 shadow-lg rounded-md">
                <div className="p-4">
                  {/* Notification items */}
                  <div className="flex items-center mb-2">
                    {/* Notification icon */}
